...
import { Container, Row, Col, Dropdown, Accordion, Card} from "react-bootstrap";
...
const Movies = () => {
  ...
  const movieSorted = (keyword, sortMethod) => {
    ...
    // 전개 연산자를 통해서 새로운 배열을 생성하고 sort()함수를 실행해야 함
              ...
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body>
                  <Dropdown data-bs-theme="dark">
                    <Dropdown.Toggle id="dropdown-button-dark-example1" variant="secondary">정렬을 선택해주세요</Dropdown.Toggle>
                    ...
                    <Dropdown.Menu>
                      ...
                      <Dropdown.Item href="#/action-3" onClick={()=>movieSorted('평점', 'desc')}>평점 내름차순</Dropdown.Item>
                      <Dropdown.Item href="#/action-3" onClick={()=>movieSorted('인기도', 'asc')}>인기도 오름차순</Dropdown.Item>
                      <Dropdown.Item href="#/action-3" onClick={()=>movieSorted('인기도', 'desc')}>인기도 내름차순</Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
                </Accordion.Body>
              </Accordion.Item>
